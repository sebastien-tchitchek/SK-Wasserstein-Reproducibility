...
namespace ttk {
  ...
  public:
    ...
    inline void setHilbertInt(const bool data) {
      HilbertInt = data;
    }

    inline void setL(const int data) {
      L = data;
    }

    inline void setChoiceHilbertDistance(const int data) {
      ChoiceHilbertDistance = data;
    }

    inline void setGLevel(const int data) {
      GLevel = data;
    }
  ...
  protected:
    ...
    // SK / Hilbert space-filling curve distance options.
    bool HilbertInt{false};
    int L{30};
