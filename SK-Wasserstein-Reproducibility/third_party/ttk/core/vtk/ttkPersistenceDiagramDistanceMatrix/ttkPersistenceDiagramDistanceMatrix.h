...
public:
  ...
  void SetHilbertInt(const int data) {
    this->HilbertInt = data != 0;
    Modified();
  }

  int GetHilbertInt() const {
    return this->HilbertInt ? 1 : 0;
  }

  void SetL(const int data) {
    this->L = data;
    Modified();
  }
  ...
  void SetChoiceHilbertDistance(const int data) {
    this->ChoiceHilbertDistance = data;
    Modified();
  }

  int GetChoiceHilbertDistance() const {
    return this->ChoiceHilbertDistance;
  }

  void SetGLevel(const int data) {
    this->GLevel = data;
    Modified();
  }
